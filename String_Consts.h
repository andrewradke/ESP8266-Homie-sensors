...
static const char default_mqtt_topicbase[] PROGMEM = "homie";
...
const String cfg_tzoffset      = "tzoffset";
const String cfg_mqtt_server   = "mqtt_server";
const String cfg_mqtt_port     = "mqtt_port";
const String cfg_mqtt_topicbase = "mqtt_topicbase";
...
const String str_cfg_tzoffset      = "Time Zone";
const String str_cfg_mqtt_server   = "MQTT server";
const String str_cfg_mqtt_port     = "MQTT port";
const String str_cfg_mqtt_topicbase = "MQTT topic base";
